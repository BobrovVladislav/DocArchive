    ...
    const getUser = async () => {
      ...
      try {
        ...
        await setUser({
          ...
          gender: data.user.gender ? data.user.gender : 'Не указано',
          birthDate: data.user.birthDate ? new Date(data.user.birthDate).toLocaleDateString('ru-RU') : 'Не указано',
          department: data.user.department,
          manager: data.user.manager,
          position: data.user.position,
          phone: data.user.contactInfo.phone ? data.user.contactInfo.phone : 'Не указано',
